...
| 指标 | 双层GNN (use_upper_graph=True) | 基线GNN (use_upper_graph=False) | 提升 |
|------|-------------------------------|--------------------------------|------|
...
### 3. [待补充] dangerous delegatecall 漏洞

实验进行中...

## 结论

双层GNN模型在unchecked external call漏洞检测上显著优于基线模型，Macro F1提升达24.12%。
